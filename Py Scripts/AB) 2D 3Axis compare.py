...
def main():
    ...
    plot_name = "PVT_CUM_NUM_D PVT_CUM_POP"

    # List of CSV file paths
    csv_files = [
        r"C:\CzechFOI-BYAGE\TERRA\PVT_CUM_NUM_D_NORM.csv",
        r"C:\CzechFOI-BYAGE\TERRA\PVT_CUM_NUM_UVX_D_NORM.csv",
        r"C:\CzechFOI-BYAGE\TERRA\PVT_CUM_NUM_VX_D_NORM.csv",
        r"C:\CzechFOI-BYAGE\TERRA\PVT_POP_TOTAL.csv",
    ...
    #        dataframes[i][age_band] = dataframes[i][age_band] / dataframes[i + 3][age_band] * 100000
    ...
    for age_band in age_bands:
        ...
        fig.add_trace(go.Scatter(x=dataframes[2].iloc[:, 0], y=dataframes[2][age_band], mode='lines', name=csv_files[2]))
        ...
        fig.add_trace(go.Scatter(x=dataframes[4].iloc[:, 0], y=dataframes[4][age_band], mode='lines', name=csv_files[4], yaxis='y2'))
        fig.add_trace(go.Scatter(x=dataframes[5].iloc[:, 0], y=dataframes[5][age_band], mode='lines', name=csv_files[5], yaxis='y2'))

...
def main():
    ...
    # Calculate the moving average for each age group over the days
    ...
    # Create 3D line plot with logarithmic color range
    fig = go.Figure()
    ...
    for i, age_group in enumerate(df.columns[1:]):
        fig.add_trace(go.Scatter3d(
            ...
            line=dict(
                color=log_z[i::len(df.columns[1:])],  # Color by log-transformed z values
                colorscale='Plasma',
                width=2,  # Line width

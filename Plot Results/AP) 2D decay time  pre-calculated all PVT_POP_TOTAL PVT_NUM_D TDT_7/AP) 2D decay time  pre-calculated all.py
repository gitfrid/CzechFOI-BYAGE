...
def main():
    ...
    plot_name = "PVT_POP_TOTAL PVT_NUM_D TDT_7"

    population_df = pd.read_csv(r"C:\CzechFOI-ByAge\TERRA\PVT_POP_TOTAL.csv", sep=',')
    deaths_df = pd.read_csv(r"C:\CzechFOI-ByAge\TERRA\PVT_NUM_D.csv", sep=',')

...
def main():
    ...
    plot_name = "PVT_CUM_NUM_UVX_div_PVT_CUM_NUM_UVX_D"
    
    # Load the CSV file without headers
    file_path = r"C:\CzechFOI-BYAGE\TERRA\PVT_CUM_NUM_UVX_div_PVT_CUM_NUM_UVX_D.csv"
    ...
    for i, day in enumerate(days):
        for j, age_group in enumerate(age_groups):
            ...
            #z.append(np.log(z_value) if z_value > 0 else 0)  # Apply logarithm to z values

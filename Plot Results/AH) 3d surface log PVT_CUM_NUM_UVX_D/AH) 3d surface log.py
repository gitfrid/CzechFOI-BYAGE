...
def main():
    ...
    plot_name = "PVT_CUM_NUM_UVX_D"
    
    # Load the CSV data
    data = pd.read_csv(r"C:\CzechFOI-BYAGE\TERRA\PVT_CUM_NUM_UVX_D.csv")
    ...
    log_values = np.log10(values + 1)  # Adding 1 to avoid log(0)
    ...
    fig.update_layout(
        title='3D Surface Plot log',autosize=False,
